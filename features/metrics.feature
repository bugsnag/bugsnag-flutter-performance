Feature: Performance Metrics
  ...
  Scenario: All metrics enabled
    ...
    * a span double attribute "bugsnag.system.cpu_mean_overhead" is greater than 0.0
  ...
  Scenario: All metrics disabled
    ...
    * every span string attribute "bugsnag.rendering.fps_minimum" does not exist
    * every span string attribute "bugsnag.rendering.fps_maximum" does not exist
    * every span string attribute "bugsnag.rendering.frozen_frames" does not exist
    * every span string attribute "bugsnag.rendering.slow_frames" does not exist
    ...
    * every span string attribute "bugsnag.system.cpu_measures_overhead" does not exist
    * every span string attribute "bugsnag.system.cpu_mean_total" does not exist
    * every span string attribute "bugsnag.system.cpu_mean_main_thread" does not exist
    * every span string attribute "bugsnag.system.cpu_mean_overhead" does not exist
    ...
    * every span string attribute "bugsnag.system.memory.spaces.device.mean" does not exist
    * every span string attribute "bugsnag.device.physical_device_memory" does not exist
    * every span string attribute "bugsnag.system.memory.spaces.device.size" does not exist
    * every span string attribute "bugsnag.system.memory.spaces.art.used" does not exist
    * every span string attribute "bugsnag.system.memory.spaces.art.mean" does not exist
    * every span string attribute "bugsnag.system.memory.spaces.art.size" does not exist
